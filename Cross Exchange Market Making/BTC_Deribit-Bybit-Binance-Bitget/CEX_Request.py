...
class Bitget_Request:
    ...
    def set_position_mode(self, mode):
        ...
        body = json.dumps({"productType": "umcbl", "holdMode": mode})
    ...
    def place_single_order(self, symbol, side, size, order_type='limit', price=None):
        ...
        print(f'order sent: {response}')  # Log response
        return orderid
