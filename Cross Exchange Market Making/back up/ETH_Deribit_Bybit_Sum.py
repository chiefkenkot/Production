...
def fetch_and_append_data(currency='ETH'):
    # Fetch data from Deribit
    deribit_data = get_book_summary_by_currency(currency)
    ...
    csv_file = f"{currency}_future_price_diff_merged.csv"
