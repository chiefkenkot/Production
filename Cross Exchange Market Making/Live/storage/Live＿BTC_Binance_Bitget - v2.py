                    ...
                    try:
                        ...
                        if elapsed_time <= 7:
                            ...
                            if cancel_status == 'No order to cancel':
                                ...
                                cancel_counter += 1
                            print(f'cancel reason: loop elasped time > 7 ({elapsed_time})')
                            break
                    ...
                    try:
                        ...
                        if elapsed_time > 7:
                            ...
                            if cancel_status == 'No order to cancel':
                                ...
                                cancel_counter += 1
                            print(f'loop elasped time > 7: {elapsed_time}')
                            break
...
# response, transaction_price = binance_request.place_order(symbol='BTCTUSD', side='BUY', order_type='MARKET', quantity=qty*2) # BTC qty
# print(response)
# print(type(transaction_price))
# print(f'price = {transaction_price}')
