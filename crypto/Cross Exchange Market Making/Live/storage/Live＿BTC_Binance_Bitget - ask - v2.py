...
def diff_rtq():
    ...
    diff_now = round((float(bitget_ask_price) - binance_ask_price)*qty, 4)
                    ...
                    try:
                        ...
                        if diff_now >= diff1:
                            ...
                            if cancel_status == 'No order to cancel':
                                ...
                                cancel_counter += 1
                                print(f'cancel reason = diff now {diff_now} < diff1 {diff1}')
                            break
                        ...
                        if counter == 5:
                            ...
                            if cancel_status == 'No order to cancel':
                                ...
                                print(f'cancel reason = counter = 5')
                                cancel_counter += 1
                    ...
                    try:
                        ...
                        if diff_now <= diff2:
                            ...
                            if cancel_status == 'No order to cancel':
                                ...
                                cancel_counter += 1
                                print(f'cancel reason = diff now {diff_now} > diff2 {diff2}')
                            time.sleep(1)
                            break
...
###### Testing Zone ######
# orderid = bitget_request.place_single_order(bitget_symbol, 'buy_single', qty, marginCoin, 'limit', 27000)
# print(orderid)
