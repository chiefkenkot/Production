...
df = pd.read_csv(f'XRP_Bybit-Bitget - {interval} Sec.csv')
# print(df)
# time.sleep(1234)
# df = df[['timestamp','Binance_BTCTUSD', 'Bybit_BTCUSDT']]
df = df[['timestamp','Bybit_XRPUSDC_bid', 'Bybit_XRPUSDC_ask' , 'Bitget_XRPUSDTUMCBL_bid' , 'Bitget_XRPUSDTUMCBL_ask']]
...
# BID
symbol_1 = 'Bybit_XRPUSDC_bid'
symbol_2 = 'Bitget_XRPUSDTUMCBL_bid'
