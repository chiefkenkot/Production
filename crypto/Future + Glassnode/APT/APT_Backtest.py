...
# klines = client.get_historical_klines("AVAXUSDT", Client.KLINE_INTERVAL_1HOUR, "12 May, 2020", "25 Jan, 2023")
klines = client.get_historical_klines("APTUSDT", Client.KLINE_INTERVAL_4HOUR, "12 May, 2020", "25 Jan, 2023")
# klines = client.get_historical_klines("AVAXUSDT", Client.KLINE_INTERVAL_1HOUR, "12 May, 2020", "25 Jan, 2023")
# klines = client.get_historical_klines("AVAXUSDT", Client.KLINE_INTERVAL_1HOUR, "12 May, 2020", "25 Jan, 2023")
...
# df = df[['Date', 'value']]
# df.to_csv('APT_data_1h.csv', mode='w', index=False, header=True)
# # df.to_csv('APT_data_4h.csv', mode='w', index=False, header=True)
# # df.to_csv('APT_data_4h.csv', mode='w', index=False, header=True)
# print(df)
#
# time.sleep(1234)
...
### Read CSV ###
# df = pd.read_csv('APT_data_1h.csv')
df = pd.read_csv('APT_data_4h.csv')
# df = pd.read_csv('APT_data_4h.csv')
df = df[['Date','value']]
