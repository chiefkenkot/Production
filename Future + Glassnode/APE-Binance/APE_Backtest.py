...
klines = client.get_historical_klines(symbol_usdt, Client.KLINE_INTERVAL_15MINUTE, "12 May, 2020", "20 Apr, 2023")
# klines = client.get_historical_klines(symbol_usdt, Client.KLINE_INTERVAL_1HOUR, "12 May, 2020", "20 Apr, 2023")
# klines = client.get_historical_klines(symbol_usdt, Client.KLINE_INTERVAL_4HOUR, "12 May, 2020", "20 Apr, 2023")
# klines = client.get_historical_klines(symbol_usdt, Client.KLINE_INTERVAL_1HOUR, "12 May, 2020", "20 Apr, 2023")

###### Data Frame ######
csv_name = symbol_usdt + '_data_15min.csv'
